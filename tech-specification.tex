...
\JournalInfo{[Pontus v0.6.0]} % Journal information
...
\begin{center}
	\begin{tabu}{l r l}
		...
		\linkdest{G__selfdestruct}{}$G_{selfdestruct}$ & 5000 & Amount of gas to pay for a $\op{SELFDESTRUCT}$ operation. \\
		...
		\linkdest{G__newaccount}{}$G_{newaccount}$ & 25000 & Paid for a $\op{CALL}$ or $\op{SELFDESTRUCT}$ operation which creates an account. \\
