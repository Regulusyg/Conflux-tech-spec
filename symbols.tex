...
% Unit of {\name} tokens
\newcommand{\unit}{{\textsf Drip}\xspace}
\newcommand{\gunit}{{\textsf GDrip}\xspace}
\newcommand{\coin}{{\textsf Conflux}\xspace}
\newcommand{\coinsign}{{\textsf CFX}\xspace}
...
\newcommand{\startdifficulty}{5\times 10^6}
\newcommand{\startdifficultyline}{5000000}
